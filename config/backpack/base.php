...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'packages/custom/base/css/base.css',
        ...
        'https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@700&family=Tajawal&display=swap',
        // Example (load font-awesome instead of line-awesome):
        // 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.2/css/all.min.css',
        'css/backpack.css', //custom css
    ...
    'project_logo' => '<img src="/assets/img/saki_logo.png" alt="سخي" style="max-width:100%; max-height:100%;">',
    'login_logo' => 'img src="/assets/img/saki_logo.png" alt="سخي" style="max-width:100%; max-height:100%;">',
    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => false,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    //    'header_class' => 'app-header bg-light border-0 navbar',
    'header_class' => 'app-header bg-light border-0 navbar navbar-dark mb-4',
    ...
    'sidebar_class' => 'sidebar sidebar-pills ms-0 bg-light ',
    ...
    //    'header_class' => 'app-header navbar bg-light border-0',
    //    'body_class' => 'app aside-menu-fixed sidebar-lg-show',
    ...
    'developer_name' => 'Awontech Engineering Team',
    ...
    */
    ...
    'authentication_column_name' => 'البريد الالكتروني',
